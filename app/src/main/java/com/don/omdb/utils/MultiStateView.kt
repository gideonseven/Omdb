...
class MultiStateView @JvmOverloads constructor(
    ...
    init {
        ...
        val multiStateViewAttr = getContext().obtainStyledAttributes(attrs, R.styleable.MultiStateView)

        val loadingViewResId =
            multiStateViewAttr.getResourceId(R.styleable.MultiStateView_loadingView, R.layout.view_state_loading)
        ...
        val emptyViewResId =
            multiStateViewAttr.getResourceId(R.styleable.MultiStateView_emptyView, R.layout.view_state_empty)
        if (emptyViewResId > -1) {
        ...
        val errorViewResId =
            multiStateViewAttr.getResourceId(R.styleable.MultiStateView_errorView, R.layout.view_state_error)
        if (errorViewResId > -1) {
        ...
        animateLayoutChanges = multiStateViewAttr.getBoolean(R.styleable.MultiStateView_animateViewChanges, false)
